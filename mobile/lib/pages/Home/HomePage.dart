...
class HomePage extends StatefulWidget {
  HomePage({this.pageInt,super.key});
  int? pageInt;
  @override
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _controller = _controller = PersistentTabController(initialIndex: widget.pageInt!);
  }
  ...
  List<PersistentBottomNavBarItem> _navBarsItems() {
    return [
      ...
      PersistentBottomNavBarItem(
        icon: Icon(CupertinoIcons.archivebox,size: config.iconSize20),
        // title: ("History"),
        activeColorPrimary: AppColors.mainColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),
      PersistentBottomNavBarItem(
        icon: Icon(CupertinoIcons.cart,size: config.iconSize20),
        // title: ("Basket"),
        activeColorPrimary: AppColors.mainColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),
      PersistentBottomNavBarItem(
        icon: Icon(CupertinoIcons.person,size: config.iconSize20),
        // title: ("Profile"),
        activeColorPrimary: AppColors.mainColor,
        inactiveColorPrimary: CupertinoColors.systemGrey,
      ),
